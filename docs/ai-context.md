...
8. **Revisi Landing Page & Referral Komisi (hasil rapat pra-rilis 2026-07-21)** — status **PENDING**, belum dieksekusi. Detail lengkap di `docs/todo.md` (section "Revisi Tertunda — Rapat Pra-Rilis"). Beberapa poin masih menunggu keputusan/klarifikasi owner: jumlah sesi paket Diamond, posisi section "Alur/Cara Daftar", warna tombol CTA "Daftar Sekarang", dan nasib e-wallet toggle di admin settings.
...
- **Paket "Diamond" (Rp1,5jt/bulan) direncanakan, belum diimplementasi** — hasil rapat pra-rilis 2026-07-21, jumlah sesi belum fix. Lihat `docs/todo.md`.
- **Tombol CTA "Daftar Sekarang" berpotensi kontras buruk** — permintaan font putih di atas background yang juga putih (tercatat 2026-07-21, belum dieksekusi), perlu klarifikasi ulang ke owner soal background-nya sebelum dikerjakan.
- **E-wallet toggle di `admin/pengaturan.blade.php` belum diputuskan nasibnya** — revisi landing page berencana hapus opsi e-wallet dari "Bayar Mudah", tapi toggle admin masih aktif sampai ada keputusan eksplisit owner.
