...
@section('title', 'NgajiNusa - Manajemen Jadwal')

@section('page-title', 'Manajemen Jadwal')
@section('page-subtitle', 'Kelola jadwal sesi belajar')
...
@section('topbar-actions')
                ...
                <button class="notif-btn" onclick="openAddModal('jadwal')" style="background:var(--primary);color:var(--white);border-color:var(--primary);width:auto;padding:0 20px;border-radius:50px;">
...
@include('admin.partials.section-tabs')
            ...
            <div class="data-panel">
                <div class="panel-header">
                    <h3><i class="fas fa-calendar-alt" style="color:var(--primary);"></i> Jadwal Sesi</h3>
                    <div class="actions">
                        <button class="btn-export" onclick="exportData()"><i class="fas fa-file-excel"></i> Export</button>
                        <button class="btn-add" onclick="openAddModal('jadwal')"><i class="fas fa-plus"></i> Buat Jadwal</button>
                    </div>
                </div>
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Fatimah A.</td>
                                <td>Ust. Ahmad</td>
                                <td><span class="status-badge active">Terjadwal</span></td>
                                <td>
                                    <div class="table-actions">
                                        <button onclick="openEditModal('jadwal', '05 Jul 2026')"><i class="fas fa-edit"></i></button>
                                        <button onclick="window.open('#','_blank')"><i class="fas fa-video"></i></button>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>Zahra N.</td>
                                <td>Ust. Fauzi</td>
                                <td><span class="status-badge pending">Reschedule</span></td>
                                <td>
                                    <div class="table-actions">
                                        <button onclick="openEditModal('jadwal', '06 Jul 2026')"><i class="fas fa-edit"></i></button>
                                        <button onclick="window.open('#','_blank')"><i class="fas fa-video"></i></button>
                                    </div>
                                </td>
                            </tr>
