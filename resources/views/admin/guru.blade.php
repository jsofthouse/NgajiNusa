...
@section('title', 'NgajiNusa - Manajemen Guru')

@section('page-title', 'Manajemen Guru')
@section('page-subtitle', 'Kelola data guru dan keahlian')
...
@section('topbar-actions')
                ...
                <button class="notif-btn" onclick="openAddModal('guru')" style="background:var(--primary);color:var(--white);border-color:var(--primary);width:auto;padding:0 20px;border-radius:50px;">
...
@include('admin.partials.section-tabs')
            ...
            <div class="data-panel">
                <div class="panel-header">
                    <h3><i class="fas fa-chalkboard-teacher" style="color:var(--primary);"></i> Daftar Guru</h3>
                    <div class="actions">
                        <button class="btn-export" onclick="exportData()"><i class="fas fa-file-excel"></i> Export</button>
                        <button class="btn-add" onclick="openAddModal('guru')"><i class="fas fa-plus"></i> Tambah</button>
                    </div>
                </div>
                <div class="table-wrap">
                    <table>
                        ...
                        <tbody>
                            <tr>
                                <td><span class="avatar-sm green">UA</span> Ust. Ahmad</td>
                                <td>Tahsin, Tajwid</td>
                                <td>✅ Bersertifikat</td>
                                <td><span class="status-badge active">Aktif</span></td>
                                <td>
                                    <div class="table-actions">
                                        <button onclick="openEditModal('guru', 'Ust. Ahmad')"><i class="fas fa-edit"></i></button>
                                        <button class="danger" onclick="confirmDelete('Ust. Ahmad')"><i class="fas fa-trash"></i></button>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td><span class="avatar-sm orange">UH</span> Ustzh. Hani</td>
                                <td>Iqra, Hijaiyah</td>
                                <td>✅ Bersertifikat</td>
                                <td><span class="status-badge active">Aktif</span></td>
                                <td>
                                    <div class="table-actions">
                                        <button onclick="openEditModal('guru', 'Ustzh. Hani')"><i class="fas fa-edit"></i></button>
                                        <button class="danger" onclick="confirmDelete('Ustzh. Hani')"><i class="fas fa-trash"></i></button>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td><span class="avatar-sm blue">UF</span> Ust. Fauzi</td>
                                <td>Hafalan, Tahsin</td>
                                <td>✅ Bersertifikat</td>
                                <td><span class="status-badge pending">Libur</span></td>
                                <td>
                                    <div class="table-actions">
                                        <button onclick="openEditModal('guru', 'Ust. Fauzi')"><i class="fas fa-edit"></i></button>
                                        <button class="danger" onclick="confirmDelete('Ust. Fauzi')"><i class="fas fa-trash"></i></button>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td><span class="avatar-sm green">UR</span> Ustzh. Rina</td>
                                <td>Tajwid, Iqra</td>
                                <td>✅ Bersertifikat</td>
                                <td><span class="status-badge active">Aktif</span></td>
                                <td>
                                    <div class="table-actions">
                                        <button onclick="openEditModal('guru', 'Ustzh. Rina')"><i class="fas fa-edit"></i></button>
                                        <button class="danger" onclick="confirmDelete('Ustzh. Rina')"><i class="fas fa-trash"></i></button>
                                    </div>
                                </td>
                            </tr>
                        </tbody>
                ...
                <div class="pagination">
                    <span class="info">Menampilkan 1-4 dari 12 guru</span>
                    <div class="pages">
                        <button>‹</button>
