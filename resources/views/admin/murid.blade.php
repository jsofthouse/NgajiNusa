...
@section('topbar-actions')
                ...
                <button class="notif-btn" onclick="openAddModal('murid')" style="background:var(--primary);color:var(--white);border-color:var(--primary);width:auto;padding:0 20px;border-radius:50px;">
...
@include('admin.partials.section-tabs')
            ...
            <div class="data-panel">
                <div class="panel-header">
                    <h3><i class="fas fa-user-graduate" style="color:var(--primary);"></i> Daftar Murid</h3>
                    <div class="actions">
                        <button class="btn-export" onclick="exportData()"><i class="fas fa-file-excel"></i> Export</button>
                        <button class="btn-add" onclick="openAddModal('murid')"><i class="fas fa-plus"></i> Tambah</button>
                    </div>
                </div>
                    ...
                    <table id="muridTable">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>fatimah@email.com</td>
                                <td>Tahsin</td>
                                <td>Pro</td>
                                <td><span class="status-badge active">Aktif</span></td>
                                <td>
                                    <div class="table-actions">
                                        <button onclick="openEditModal('murid', 'Fatimah A.')"><i class="fas fa-edit"></i></button>
                                        <button class="danger" onclick="confirmDelete('Fatimah A.')"><i class="fas fa-trash"></i></button>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <div class="table-actions">
                                        <button onclick="openEditModal('murid', 'Muhammad R.')"><i class="fas fa-edit"></i></button>
                                        <button class="danger" onclick="confirmDelete('Muhammad R.')"><i class="fas fa-trash"></i></button>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td><span class="avatar-sm blue">ZN</span> Zahra N.</td>
                                <td>zahra@email.com</td>
                                <td>Tajwid</td>
                                <td>Premium</td>
                                <td><span class="status-badge completed">Selesai</span></td>
                                <td>
                                    <div class="table-actions">
                                        <button onclick="openEditModal('murid', 'Zahra N.')"><i class="fas fa-edit"></i></button>
                                        <button class="danger" onclick="confirmDelete('Zahra N.')"><i class="fas fa-trash"></i></button>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <div class="table-actions">
                                        <button onclick="openEditModal('murid', 'Adam S.')"><i class="fas fa-edit"></i></button>
                                        <button class="danger" onclick="confirmDelete('Adam S.')"><i class="fas fa-trash"></i></button>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>Tahsin</td>
                                <td>Pro</td>
                                <td><span class="status-badge cancelled">Nonaktif</span></td>
                                <td>
                                    <div class="table-actions">
                                        <button onclick="openEditModal('murid', 'Nisa A.')"><i class="fas fa-edit"></i></button>
                                        <button class="danger" onclick="confirmDelete('Nisa A.')"><i class="fas fa-trash"></i></button>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td><span class="avatar-sm blue">RA</span> Rizki A.</td>
                                ...
                                <td>
                                    <div class="table-actions">
                                        <button onclick="openEditModal('murid', 'Rizki A.')"><i class="fas fa-edit"></i></button>
                                        <button class="danger" onclick="confirmDelete('Rizki A.')"><i class="fas fa-trash"></i></button>
                                    </div>
                                </td>
                            </tr>
                        </tbody>
                ...
                <div class="pagination">
                    <span class="info">Menampilkan 1-6 dari 142 murid</span>
                    <div class="pages">
                        <button>‹</button>
