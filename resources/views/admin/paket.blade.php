...
@section('title', 'NgajiNusa - Manajemen Paket')

@section('page-title', 'Manajemen Paket')
@section('page-subtitle', 'Kelola paket belajar dan harga')
...
@section('topbar-actions')
                ...
                <button class="notif-btn" onclick="openAddModal('paket')" style="background:var(--primary);color:var(--white);border-color:var(--primary);width:auto;padding:0 20px;border-radius:50px;">
...
@include('admin.partials.section-tabs')
            ...
            <div class="data-panel">
                <div class="panel-header">
                    <h3><i class="fas fa-tags" style="color:var(--primary);"></i> Kelola Paket Belajar</h3>
                    <div class="actions">
                        <button class="btn-add" onclick="openAddModal('paket')"><i class="fas fa-plus"></i> Tambah Paket</button>
                    </div>
                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="table-actions">
                                        <button onclick="openEditModal('paket', 'Basic')"><i class="fas fa-edit"></i></button>
                                        <button class="danger" onclick="confirmDelete('Basic')"><i class="fas fa-trash"></i></button>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <div class="table-actions">
                                        <button onclick="openEditModal('paket', 'Pro')"><i class="fas fa-edit"></i></button>
                                        <button class="danger" onclick="confirmDelete('Pro')"><i class="fas fa-trash"></i></button>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <div class="table-actions">
                                        <button onclick="openEditModal('paket', 'Premium')"><i class="fas fa-edit"></i></button>
                                        <button class="danger" onclick="confirmDelete('Premium')"><i class="fas fa-trash"></i></button>
                                    </div>
                                </td>
                            </tr>
                        </tbody>
